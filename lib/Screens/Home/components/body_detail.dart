...
class BodyDetail extends StatelessWidget {
  final String date;
  final String urlGetDate;
  const BodyDetail({
    Key key,
    this.date,
    this.urlGetDate =  "http://192.168.1.2:3000/v1/getUseDate",
  }):super(key:key);
  Future<List<dynamic>> fetchUses() async {    var result = await http.get(urlGetDate+"?id=1&date=$date");
